...
image:https://img.shields.io/github/workflow/status/{project-owner}/{project-name}/CodeQL?logo=github&label=CodeQL["CodeQL", link="https://github.com/{project-owner}/{project-name}/actions"]
