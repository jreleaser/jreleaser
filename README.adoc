...
image:https://img.shields.io/lgtm/alerts/g/{project-owner}/{project-owner}.svg?logo=lgtm&logoWidth=18[https://lgtm.com/projects/g/{project-owner}/{project-owner}/alerts]
image:https://img.shields.io/lgtm/grade/java/g/{project-owner}/{project-owner}.svg?logo=lgtm&logoWidth=18[https://lgtm.com/projects/g/{project-owner}/{project-owner}/context:java]
