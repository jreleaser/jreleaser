...
public class AppImagePackagerProcessorFactory implements PackagerProcessorFactory<AppImagePackager, AppImagePackagerProcessor> {
    ...
    public String getName() {
        return org.jreleaser.model.api.packagers.AppImagePackager.TYPE;
    }

    @Override
    public AppImagePackagerProcessor getPackagerNameProcessor(JReleaserContext context) {
        return new AppImagePackagerProcessor(context);
    }
}