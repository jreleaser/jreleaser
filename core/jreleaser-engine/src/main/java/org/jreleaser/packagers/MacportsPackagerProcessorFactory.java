...
public class MacportsPackagerProcessorFactory implements PackagerProcessorFactory<MacportsPackager, MacportsPackagerProcessor> {
    @Override
    public String getName() {
        return org.jreleaser.model.api.packagers.MacportsPackager.TYPE;
    }
