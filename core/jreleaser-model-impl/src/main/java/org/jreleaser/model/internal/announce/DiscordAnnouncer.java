...
import static org.jreleaser.model.api.announce.DiscordAnnouncer.TYPE;
...
public final class DiscordAnnouncer extends AbstractAnnouncer<DiscordAnnouncer> {
    ...
    private final org.jreleaser.model.api.announce.DiscordAnnouncer immutable = new org.jreleaser.model.api.announce.DiscordAnnouncer() {
        ...
        public boolean isSnapshotSupported() {
            return DiscordAnnouncer.this.isSnapshotSupported();
        }
        ...
        public boolean isEnabled() {
            return DiscordAnnouncer.this.isEnabled();
        }

        @Override
        public Map<String, Object> asMap(boolean full) {
            return unmodifiableMap(DiscordAnnouncer.this.asMap(full));
        }
    ...
    @Override
    public void merge(DiscordAnnouncer source) {
        super.merge(source);
    ...
    public String getResolvedWebhook() {
        return Env.env(org.jreleaser.model.api.announce.DiscordAnnouncer.DISCORD_WEBHOOK, webhook);
    }
