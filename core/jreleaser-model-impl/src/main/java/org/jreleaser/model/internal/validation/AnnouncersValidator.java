...
import static org.jreleaser.model.internal.validation.ArticleAnnouncerValidator.validateArticle;
import static org.jreleaser.model.internal.validation.DiscordAnnouncerValidator.validateDiscord;
import static org.jreleaser.model.internal.validation.DiscussionsAnnouncerValidator.validateDiscussions;
import static org.jreleaser.model.internal.validation.GitterAnnouncerValidator.validateGitter;
import static org.jreleaser.model.internal.validation.GoogleChatAnnouncerValidator.validateGoogleChat;
import static org.jreleaser.model.internal.validation.HttpAnnouncerValidator.validateHttpAnnouncers;
import static org.jreleaser.model.internal.validation.MastodonAnnouncerValidator.validateMastodon;
import static org.jreleaser.model.internal.validation.MattermostAnnouncerValidator.validateMattermost;
import static org.jreleaser.model.internal.validation.SdkmanAnnouncerValidator.validateSdkmanAnnouncer;
import static org.jreleaser.model.internal.validation.SlackAnnouncerValidator.validateSlack;
import static org.jreleaser.model.internal.validation.SmtpAnnouncerValidator.validateSmtp;
import static org.jreleaser.model.internal.validation.TeamsAnnouncerValidator.validateTeams;
import static org.jreleaser.model.internal.validation.TelegramAnnouncerValidator.validateTelegram;
import static org.jreleaser.model.internal.validation.TwitterAnnouncerValidator.validateTwitter;
import static org.jreleaser.model.internal.validation.WebhooksAnnouncerValidator.validateWebhooks;
import static org.jreleaser.model.internal.validation.ZulipAnnouncerValidator.validateZulip;
