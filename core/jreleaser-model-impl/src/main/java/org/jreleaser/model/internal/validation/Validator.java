...
class Validator {
    ...
    static void validateFileSet(JReleaserContext context, Mode mode, Assembler assembler, FileSet fileSet, int index, Errors errors) {
    ...
    static void validateScreenshots(JReleaserContext context, Mode mode, List<Screenshot> screenshots, Errors errors, String base) {
    ...
    static void validateIcons(JReleaserContext context, Mode mode, List<Icon> icons, Errors errors, String base) {
        validateIcons(context, mode, icons, errors, base, true);
    }

    static void validateIcons(JReleaserContext context, Mode mode, List<Icon> icons, Errors errors, String base, boolean validatePrimary) {
        if (validatePrimary) {
            if (icons.size() == 1) {
