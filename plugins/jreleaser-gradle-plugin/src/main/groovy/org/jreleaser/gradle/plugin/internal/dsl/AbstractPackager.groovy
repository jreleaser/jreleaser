 ...
 */
@CompileStatic
abstract class AbstractPackager implements org.jreleaser.gradle.plugin.dsl.Packager {
    ...
    protected <T extends Packager> void fillPackagerProperties(T packager) {
