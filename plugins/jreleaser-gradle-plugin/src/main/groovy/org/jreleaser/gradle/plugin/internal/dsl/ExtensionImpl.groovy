...
class ExtensionImpl implements Extension {
    ...
    org.jreleaser.model.Extension toModel() {
        org.jreleaser.model.Extension extension = new org.jreleaser.model.Extension()
        extension.name = name
    ...
    static class ProviderImpl implements Provider {
        ...
        ProviderImpl(ObjectFactory objects) {
            type = objects.property(String).convention(Providers.notDefined())
            properties = objects.mapProperty(String, Object).convention(Providers.notDefined())
        }

        org.jreleaser.model.Extension.Provider toModel() {
            org.jreleaser.model.Extension.Provider provider = new org.jreleaser.model.Extension.Provider()
