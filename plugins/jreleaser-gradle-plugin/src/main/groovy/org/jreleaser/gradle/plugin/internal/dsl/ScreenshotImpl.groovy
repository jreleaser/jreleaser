...
class ScreenshotImpl implements Screenshot {
    ...
    ScreenshotImpl(ObjectFactory objects) {
        ...
        primary = objects.property(Boolean).convention(Providers.notDefined())
    ...
    org.jreleaser.model.Screenshot toModel() {
        org.jreleaser.model.Screenshot screenshot = new org.jreleaser.model.Screenshot()
