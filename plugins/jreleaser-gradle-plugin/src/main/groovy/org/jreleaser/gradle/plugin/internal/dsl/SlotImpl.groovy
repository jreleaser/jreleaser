 ...
 */
@CompileStatic
class SlotImpl implements org.jreleaser.gradle.plugin.dsl.Slot {
    String name
    ...
    org.jreleaser.model.Slot toModel() {
        org.jreleaser.model.Slot slot = new org.jreleaser.model.Slot()
        slot.name = name
