 ...
 */
@CompileStatic
class ZulipAnnouncerImpl extends AbstractAnnouncer implements ZulipAnnouncer {
    ...
    @Inject
    ZulipAnnouncerImpl(ObjectFactory objects) {
        super(objects)
        account = objects.property(String).convention(Providers.<String> notDefined())
