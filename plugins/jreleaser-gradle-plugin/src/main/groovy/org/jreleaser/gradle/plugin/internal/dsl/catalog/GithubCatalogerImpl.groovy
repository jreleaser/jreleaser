 ...
 */
@CompileStatic
class GithubCatalogerImpl extends AbstractCataloger implements GithubCataloger {
    ...
    @Inject
    GithubCatalogerImpl(ObjectFactory objects) {
        super(objects)
    ...
    org.jreleaser.model.internal.catalog.GithubCataloger toModel() {
        org.jreleaser.model.internal.catalog.GithubCataloger cataloger = new org.jreleaser.model.internal.catalog.GithubCataloger()
