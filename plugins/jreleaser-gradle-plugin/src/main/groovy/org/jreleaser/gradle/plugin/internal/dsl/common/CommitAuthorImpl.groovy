...
class CommitAuthorImpl implements CommitAuthor {
    ...
    CommitAuthorImpl(ObjectFactory objects) {
        ...
        email = objects.property(String).convention(Providers.<String> notDefined())
    }
    ...
    org.jreleaser.model.internal.common.CommitAuthor toModel() {
        org.jreleaser.model.internal.common.CommitAuthor ca = new org.jreleaser.model.internal.common.CommitAuthor()
