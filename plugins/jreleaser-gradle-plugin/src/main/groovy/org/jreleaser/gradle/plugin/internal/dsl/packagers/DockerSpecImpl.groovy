...
class DockerSpecImpl extends AbstractDockerConfiguration implements DockerSpec {
    ...
    org.jreleaser.model.internal.packagers.DockerSpec toModel() {
        org.jreleaser.model.internal.packagers.DockerSpec spec = new org.jreleaser.model.internal.packagers.DockerSpec()
        spec.name = name
        toModel(spec)
