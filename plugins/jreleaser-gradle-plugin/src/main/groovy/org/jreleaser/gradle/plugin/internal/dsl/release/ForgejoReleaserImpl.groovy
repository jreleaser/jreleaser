 ...
 */
@CompileStatic
class ForgejoReleaserImpl extends BaseReleaserImpl implements ForgejoReleaser {
    ...
    @Inject
    ForgejoReleaserImpl(ObjectFactory objects) {
        super(objects)
    ...
    org.jreleaser.model.internal.release.ForgejoReleaser toModel() {
        org.jreleaser.model.internal.release.ForgejoReleaser service = new org.jreleaser.model.internal.release.ForgejoReleaser()
        toModel(service)
