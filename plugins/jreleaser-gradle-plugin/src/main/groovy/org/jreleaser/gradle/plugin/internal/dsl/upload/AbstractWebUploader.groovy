...
abstract class AbstractWebUploader extends AbstractUploader implements WebUploader {
    ...
    AbstractWebUploader(ObjectFactory objects) {
        super(objects)
        uploadUrl = objects.property(String).convention(Providers.<String> notDefined())
    ...
    protected <U extends org.jreleaser.model.internal.upload.WebUploader> void fillProperties(U uploader) {
