 ...
 * @since 0.2.0
 */
abstract class AbstractGitterCommand implements GitterCommand {
    protected final boolean dryrun;
    protected final Gitter gitter;

    protected AbstractGitterCommand(JReleaserLogger logger,
                                    int connectTimeout,
                                    int readTimeout,
                                    boolean dryrun) {
        this.gitter = new Gitter(logger, connectTimeout, readTimeout, dryrun);
        this.dryrun = dryrun;
    }
