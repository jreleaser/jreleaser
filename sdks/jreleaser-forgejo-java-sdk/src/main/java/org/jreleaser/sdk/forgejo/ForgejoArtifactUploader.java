 ...
 * @since 1.18.0
 */
public class ForgejoArtifactUploader extends AbstractArtifactUploader<org.jreleaser.model.api.upload.ForgejoUploader, ForgejoUploader> {
    private ForgejoUploader uploader;
    ...
    @Override
    public ForgejoUploader getUploader() {
        return uploader;
    }

    @Override
    public void setUploader(ForgejoUploader uploader) {
