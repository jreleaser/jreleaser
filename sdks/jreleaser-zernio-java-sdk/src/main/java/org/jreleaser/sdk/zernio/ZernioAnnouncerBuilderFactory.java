...
public class ZernioAnnouncerBuilderFactory implements AnnouncerBuilderFactory<ZernioAnnouncer, ZernioAnnouncerBuilder> {
    @Override
    ...
    @Override
    public ZernioAnnouncerBuilder getBuilder() {
        return new ZernioAnnouncerBuilder();
    }
}