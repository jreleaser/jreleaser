...
public class ZulipAnnouncerBuilderFactory implements AnnouncerBuilderFactory<ZulipAnnouncer, ZulipAnnouncerBuilder> {
    @Override
    ...
    @Override
    public ZulipAnnouncerBuilder getBuilder() {
        return new ZulipAnnouncerBuilder();
    }
}