...
| Linux x32 (glibc) | {{#f_release_download_url}}jreleaser-standalone-{{projectEffectiveVersion}}-linux-x86_32.zip{{/f_release_download_url}} |  |
...
| Windows x32 | {{#f_release_download_url}}jreleaser-standalone-{{projectEffectiveVersion}}-windows-x86_32.zip{{/f_release_download_url}} |  |
