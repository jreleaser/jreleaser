...
📝 Small improvements to changelog generator. A new f_file_exists function may be used with templates
🚚 Lots of dependency updates, keeping up with latest versions and fixes
