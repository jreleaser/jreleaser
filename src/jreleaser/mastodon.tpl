...
📣 Announce releases to OpenCollective (https://mastodon.opencollective.com/@opencollective) {{projectLinkDocumentation}}/reference/announce/opencollective.html
...
💻 Command hooks may supply structured output that feeds into the resolved model {{projectLinkDocumentation}}/reference/hooks/command.html#_output
